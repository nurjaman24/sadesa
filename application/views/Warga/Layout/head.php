...
<head>
    ...
    <title>SADESA - Warga Desa | Satu Pintu Administrasi Desa</title>
    <meta name="description" content="">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- favicon ============================================ -->
    <link rel="shortcut icon" type="image/x-icon" href="<?= base_url('asset/img/logo/logosn.png')?>">
    <!-- Google Fonts ============================================ -->
    ...
    <!-- educate icon CSS ============================================ -->
    <link rel="stylesheet" href="<?= base_url('asset/css/educate-custon-icon.css')?>">
    <!-- morrisjs CSS	============================================ -->
    ...
    <!-- Preloader CSS		============================================ -->
    <link rel="stylesheet" href="<?= base_url('asset/css/preloader/preloader-style.css')?>">
    <!-- x-editor CSS ============================================ -->
    <link rel="stylesheet" href="<?= base_url('asset/css/editor/select2.css')?>">
    <link rel="stylesheet" href="<?= base_url('asset/css/editor/datetimepicker.css')?>">
    <link rel="stylesheet" href="<?= base_url('asset/css/editor/bootstrap-editable.css')?>">
    <link rel="stylesheet" href="<?= base_url('asset/css/editor/x-editor-style.css')?>">
    <!-- normalize CSS ============================================ -->
