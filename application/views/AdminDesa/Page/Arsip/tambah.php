                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="all-form-element-inner">
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                ?>
                                                                    <option value="<?= $tdes->id_desa?>"><?= $tdes->nama_desa?></option>
                                                                <?php }?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">Penduduk<code>*</code></label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <select name="id_penduduk" class="form-control" required>
                                                                <?php
                                                                    foreach($tb_penduduk as $tpen){
                                                                ?>
                                                                    <option value="<?= $tpen->id_penduduk?>"><?= $tpen->nik?> | <?= $tpen->nama?></option>
                                                                <?php }?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                ...
                                                                ?>
                                                                    <option value="<?= $tjd->id_jenis?>"><?= $tjd->jenis_dokumen?></option>
                                                                <?php }?>
                                                                </select>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="form-group-inner">
                                                        <div class="row">
                                                            <div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
                                                                <label class="login2 pull-right pull-right-pro">file dokumen <code>*</code></label>
                                                            </div>
                                                            <div class="col-lg-9 col-md-9 col-sm-9 col-xs-12">
                                                                <input type="file" class="form-control" name="file_dokumen" required maxlength="20" />
                                                            </div>
                                                        </div>
                                                    </div>
